const webpack = require( 'webpack' ),
      ...
      build_version = package_json.version.substr( 0, package_json.version.length - 2 ) + '.' +
                      ( now.getFullYear() - 2000 ) + lpad( now.getMonth() ) + lpad( now.getDate() ) +
      ...
      plugins = [
          ...
          new HtmlWebpackPlugin( {
              hash           : true,
              filename       : '../../resources/views/js-bundles-autogenerated.blade.php',
              templateContent: '<script>window._VERSION="' + build_version + '"</script>'
          } ),
